...
export declare namespace DriverNotifyRiderDroppedOffParams {
    function fromObject(obj: any): DriverNotifyRiderDroppedOffParams;
}
...
export declare namespace DriverNotifyRiderDroppedOffResult {
    function fromObject(obj: any): DriverNotifyRiderDroppedOffResult;
}
