...
export declare namespace UserAuthenticateParams {
    function fromObject(obj: any): UserAuthenticateParams;
}
/**
...
export declare namespace UserAuthenticateResult {
    function fromObject(obj: any): UserAuthenticateResult;
}
