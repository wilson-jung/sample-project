...
export declare namespace DriverGetNoticeVersionParams {
    function fromObject(obj: any): DriverGetNoticeVersionParams;
}
...
export declare namespace DriverGetNoticeVersionResult {
    function fromObject(obj: any): DriverGetNoticeVersionResult;
}
