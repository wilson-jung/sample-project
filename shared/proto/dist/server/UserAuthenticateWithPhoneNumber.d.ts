...
export declare namespace UserAuthenticateWithPhoneNumberParams {
    function fromObject(obj: any): UserAuthenticateWithPhoneNumberParams;
}
/**
...
export declare namespace UserAuthenticateWithPhoneNumberResult {
    function fromObject(obj: any): UserAuthenticateWithPhoneNumberResult;
}
