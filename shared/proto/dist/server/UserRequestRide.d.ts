...
export declare namespace UserRequestRideParams {
    function fromObject(obj: any): UserRequestRideParams;
    /**
     ...
     * CURRENT :
       *  현재 위치를 통해 설정한 경우
     */
    type LocationSource = 'UNSPECIFIED' | 'GEOCODE' | 'PLACE' | 'HISTORY' | 'FAVORITE' | 'CURRENT';
    function LocationSource_fromString(str: string): LocationSource | undefined;
}
...
export declare namespace UserRequestRideResult {
    function fromObject(obj: any): UserRequestRideResult;
}
