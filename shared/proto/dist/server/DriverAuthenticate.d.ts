...
export declare namespace DriverAuthenticateParams {
    function fromObject(obj: any): DriverAuthenticateParams;
}
/**
...
export declare namespace DriverAuthenticateResult {
    function fromObject(obj: any): DriverAuthenticateResult;
}
