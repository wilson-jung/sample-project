...
export declare namespace UserCreatePaymentMethodWithCardParams {
    function fromObject(obj: any): UserCreatePaymentMethodWithCardParams;
}
export interface UserCreatePaymentMethodWithCardResult {
    paymentMethod?: PaymentMethodDTO;
}
export declare namespace UserCreatePaymentMethodWithCardResult {
    function fromObject(obj: any): UserCreatePaymentMethodWithCardResult;
}
