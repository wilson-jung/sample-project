...
export namespace DriverGetCurrentLocationParams {
  export function fromObject(obj: any): DriverGetCurrentLocationParams {
    return {
      ...obj,
    }
  }
...
export namespace DriverGetCurrentLocationResult {
  export function fromObject(obj: any): DriverGetCurrentLocationResult {
    return {
      ...obj,
