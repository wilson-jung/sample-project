...
export namespace DriverNotifyDriverArrivedParams {
  export function fromObject(obj: any): DriverNotifyDriverArrivedParams {
    return {
      ...obj,
...
export namespace DriverNotifyDriverArrivedResult {
  export function fromObject(obj: any): DriverNotifyDriverArrivedResult {
    return {
      ...obj,
      ride: obj.ride != null ? RideDTO.fromObject(obj.ride) : undefined,
      isUserFirstRide: obj.isUserFirstRide != null ? BoolValue.fromObject(obj.isUserFirstRide) : undefined,
      notice: obj.notice != null ? DriverNotifyDriverArrivedResult.Notice.fromObject(obj.notice) : undefined,
    }
  }
