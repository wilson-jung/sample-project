...
export namespace DriverAuthenticateGigDriverParams {
  export function fromObject(obj: any): DriverAuthenticateGigDriverParams {
    return {
      ...obj,
...
export namespace DriverAuthenticateGigDriverResult {
  export function fromObject(obj: any): DriverAuthenticateGigDriverResult {
    return {
      ...obj,
    }
  }
