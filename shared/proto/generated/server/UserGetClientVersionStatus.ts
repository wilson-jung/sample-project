...
export namespace UserGetClientVersionStatusParams {
  export function fromObject(obj: any): UserGetClientVersionStatusParams {
    return {
      ...obj,
    }
  }
...
export namespace UserGetClientVersionStatusResult {
  export function fromObject(obj: any): UserGetClientVersionStatusResult {
    return {
      ...obj,
      status: UserGetClientVersionStatusResult.Status_fromString(obj.status),
