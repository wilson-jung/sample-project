...
export namespace UserGetNoticeVersionParams {
  export function fromObject(obj: any): UserGetNoticeVersionParams {
    return {
      ...obj,
...
export namespace UserGetNoticeVersionResult {
  export function fromObject(obj: any): UserGetNoticeVersionResult {
    return {
      ...obj,
