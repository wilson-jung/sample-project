...
export namespace DriverUpdateDriverLocationParams {
  export function fromObject(obj: any): DriverUpdateDriverLocationParams {
    return {
      ...obj,
      entries: obj.entries.map((v: any) => DriverUpdateDriverLocationParams.Entry.fromObject(v)),
      sendTimeMs: obj.sendTimeMs.toString(),
    }
  }
  ...
  export namespace Entry {
    export function fromObject(obj: any): Entry {
      return {
        ...
        correctedLocation: obj.correctedLocation != null ? Location.fromObject(obj.correctedLocation) : undefined,
        locationAccuracy: obj.locationAccuracy != null ? DoubleValue.fromObject(obj.locationAccuracy) : undefined,
        bearing: obj.bearing != null ? DoubleValue.fromObject(obj.bearing) : undefined,
        correctedBearing: obj.correctedBearing != null ? DoubleValue.fromObject(obj.correctedBearing) : undefined,
        bearingAccuracy: obj.bearingAccuracy != null ? DoubleValue.fromObject(obj.bearingAccuracy) : undefined,
        speed: obj.speed != null ? DoubleValue.fromObject(obj.speed) : undefined,
        speedAccuracy: obj.speedAccuracy != null ? DoubleValue.fromObject(obj.speedAccuracy) : undefined,
        altitude: obj.altitude != null ? DoubleValue.fromObject(obj.altitude) : undefined,
        altitudeAccuracy: obj.altitudeAccuracy != null ? DoubleValue.fromObject(obj.altitudeAccuracy) : undefined,
        satelliteCount: obj.satelliteCount != null ? Int32Value.fromObject(obj.satelliteCount) : undefined,
        satelliteUsedInFixCount: obj.satelliteUsedInFixCount != null ? Int32Value.fromObject(obj.satelliteUsedInFixCount) : undefined,
        satelliteCountMs: obj.satelliteCountMs != null ? Int64Value.fromObject(obj.satelliteCountMs) : undefined,
        isMockProvider: obj.isMockProvider != null ? BoolValue.fromObject(obj.isMockProvider) : undefined,
        elapsedRealtimeNanos: obj.elapsedRealtimeNanos.toString(),
        timeMs: obj.timeMs.toString(),
        systemTimeMs: obj.systemTimeMs.toString(),
      }
    }
  }
}
...
export namespace DriverUpdateDriverLocationResult {
  export function fromObject(obj: any): DriverUpdateDriverLocationResult {
    return {
      ...obj,
      nextAfterMs: obj.nextAfterMs.toString(),
    }
  }
}
