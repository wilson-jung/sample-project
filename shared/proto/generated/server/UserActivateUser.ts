...
export namespace UserActivateUserParams {
  export function fromObject(obj: any): UserActivateUserParams {
    return {
      ...obj,
...
export namespace UserActivateUserResult {
  export function fromObject(obj: any): UserActivateUserResult {
    return {
      ...obj,
    }
  }
