...
export namespace UserListCouponsParams {
  export function fromObject(obj: any): UserListCouponsParams {
    return {
      ...obj,
      rideType: obj.rideType != null ? StringValue.fromObject(obj.rideType) : undefined,
      tripParameters: obj.tripParameters != null ? StringValue.fromObject(obj.tripParameters) : undefined,
...
export namespace UserListCouponsResult {
  export function fromObject(obj: any): UserListCouponsResult {
    return {
      ...obj,
      coupons: obj.coupons.map((v: any) => CouponDTO.fromObject(v)),
      nextToken: obj.nextToken != null ? StringValue.fromObject(obj.nextToken) : undefined,
      passportMembershipNudgeCoupon: obj.passportMembershipNudgeCoupon != null ? UserListCouponsResult.PassportMembershipNudgeCoupon.fromObject(obj.passportMembershipNudgeCoupon) : undefined,
      socarPassportMembershipNudge: obj.socarPassportMembershipNudge != null ? UserListCouponsResult.SocarPassportMembershipNudge.fromObject(obj.socarPassportMembershipNudge) : undefined,
    }
  }

  export interface PassportMembershipNudgeCoupon {
    /**
  ...
  export namespace PassportMembershipNudgeCoupon {
    export function fromObject(obj: any): PassportMembershipNudgeCoupon {
      return {
        ...obj,
      }
    }
  ...
  export interface SocarPassportMembershipNudge {
    /**
  ...
  export namespace SocarPassportMembershipNudge {
    export function fromObject(obj: any): SocarPassportMembershipNudge {
      return {
        ...obj,
      }
    }
