...
export function ErrorCode_fromString(str: string): ErrorCode | undefined {
  switch (str) {
    ...
    case "UNAVAILABLE_RIDE_TYPE":
    case "UPGRADE_NEEDED":
    case "UNAVAILABLE_TIME":
    case "ASSIST_REGISTRATION_REQUIRED":
    case "PAYMENT_METHOD_NOT_REGISTERED_FOR_ASSIST":
    case "INVALID_PAYMENT_PROFILE_STATUS":
    case "INACTIVE_USER":
    case "UNAVAILABLE_WAYPOINTS":
    case "RIDE_ALREADY_REVIEWED":
    case "RIDE_REVIEW_DOES_NOT_EXIST":
    case "TRIP_ALREADY_REVIEWED":
    case "RIDE_RESERVATION_ALREADY_ACCEPTED":
    case "PAYMENT_METHOD_EXPIRED":
    case "HAS_FAILED_PAYMENT":
    case "HAS_UPDATED_TERMS":
    case "HAS_UPDATED_FEE_TERMS":
    case "INSUFFICIENT_BIZ_CREDIT":
    case "TIP_WITH_BIZ_CREDIT":
    case "PAYMENT_METHOD_REGISTER_FAILED":
    case "AUTHORIZATION_REQUIRED":
    case "INVALID_ACCESS_TOKEN":
    case "INVALID_PASSWORD":
    case "INVALID_ESTIMATION_TOKEN":
    case "REESTIMATION_NEEDED":
    case "INVALID_PHONE_NUMBER":
    case "TOO_FAR_PICKUP_POINT":
    case "TOO_FAR_BETWEEN_ORIGIN_AND_PICKUP_POINT":
    case "VEHICLE_CONTROL_FAILURE":
    case "CONFIRM_REQUIRED":
    case "BAN_CONFIRM_REQUIRED":
    case "IMPORTANT_CONFIRM_REQUIRED":
    case "INVALID_VERIFICATION_CODE":
    case "VERIFICATION_TOKEN_EXPIRED":
    case "INVALID_VERIFICATION_TOKEN":
    case "VERIFIED_TOKEN_EXPIRED":
    case "INVALID_VERIFIED_TOKEN":
    case "INVALID_RESET_PASSWORD_TOKEN":
    case "RESET_PASSWORD_TOKEN_EXPIRED":
    case "RIDE_COUPON_REGISTER_FAILURE":
    case "RIDE_COUPON_NOT_FOUND":
    case "ACCEPT_TOKEN_EXPIRED":
    case "INVALID_ACCEPT_TOKEN":
    case "INVALID_ACCEPTING_TERMS_COMBINATION":
    case "RIDE_COUPON_UNAVAILABLE":
    case "INVALID_IDENTITY_CERTIFICATION_TOKEN":
    case "IDENTITY_CERTIFICATION_TOKEN_EXPIRED":
    case "IDENTITY_CERTIFICATION_REQUIRED":
    case "DRIVER_LICENSE_REGISTER_REQUIRED":
    case "DRIVER_PROTECTION_FEE_PRODUCT_PURCHASE_FAILED":
    case "PAYMENT_METHOD_REGISTER_REQUIRED":
    case "DRIVER_PROTECTION_FEE_PRODUCT_PURCHASE_REQUIRED":
    case "DRIVER_LICENSE_REGISTER_FAILED":
    case "INVALID_DRIVER_LICENSE_FORMAT":
    case "INVALID_DRIVER_PROTECTION_FEE_PRODUCT":
    case "DRIVER_LICENSE_VERIFY_FAILED":
    case "DAERI_MISSION_PREFERENCES_REQUIRED":
    case "INVALID_GIG_DRIVER_LICENSE_STATUS":
    case "INVALID_DRIVER_MISSION_STATUS":
    case "DRIVER_DELETE_FAILED_PENDING_PAYMENT_EXIST":
    case "DRIVER_DELETE_FAILED_REMAIN_POINT_EXIST":
    case "ACCIDENT_ALREADY_REPORTED":
    case "TERMS_ALREADY_ACCEPTED":
    ...
    case "CARD_REGISTRATION_FAILURE":
    case "PAYMENT_METHOD_COUNT_LIMIT_EXCEEDED":
    case "PAYMENT_METHOD_DOES_NOT_EXIST":
    case "PAYMENT_METHOD_DELETE_FAILURE":
    case "UNVERIFIED_PHONE_NUMBER":
    case "INVALID_LICENSE_PLATE_FORMAT":
    case "SMS_SEND_FAILURE":
    case "EMAIL_SEND_FAILURE":
    case "REQUEST_FAILURE":
    case "ASSIST_REGISTRATION_FAILURE":
    case "ASSIST_CANCEL_FAILURE":
    case "BUSINESS_PAYMENT_PROFILE_CREATE_FAILURE":
    case "PAYMENT_PROFILE_DELETE_FAILURE":
    case "PAYMENT_PROFILE_CHANGED":
    case "BUSINESS_PAYMENT_PROFILE_ACTIVATION_UNAVAILBLE":
    case "BUSINESS_PAYMENT_PROFILE_VERIFICATION_NEEDED":
    case "PAYMENT_PROFILE_DOES_NOT_EXIST":
    case "INVALID_PAYMENT_METHOD_STATUS":
    case "INVALID_RIDE_FEE":
    case "RIDE_RESERVATION_EXCEED_LIMIT":
    case "RIDE_RESERVATION_EXPECTED_PICK_UP_AT_NOT_IN_AVAILABLE_TIME":
    case "RIDE_RESERVATION_ALREADY_EXISTS_IN_EXPECTED_PICK_UP_AT_LIST":
    case "RIDE_RESERVATION_ALREADY_RESERVED":
    return str
 ...
 */
export type ExtraKeys = 'UNSPECIFIED' | 'PASSWORD_WEAKNESS_REASON';

export function ExtraKeys_fromString(str: string): ExtraKeys | undefined {
  switch (str) {
    case "UNSPECIFIED":
    case "PASSWORD_WEAKNESS_REASON":
    return str
    default: return undefined
  }
}
...
export namespace ErrorDTO {
  export function fromObject(obj: any): ErrorDTO {
    return {
      ...obj,
      code: ErrorCode_fromString(obj.code),
